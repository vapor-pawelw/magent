...
- Context menu order for non-main threads starts with `Pin/Unpin`, `Keep Alive`, `Kill All Sessions` (when live sessions exist), then Jira, then a separator, then rename/description/icon actions.
